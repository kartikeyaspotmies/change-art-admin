    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: 'new-jobs',    label: 'New Jobs',        to: '/admin/new-jobs',    icon: ScrollText, badgeAccent: 'red' },
          { id: 'new-quotes',  label: 'New Quotes',      to: '/admin/new-quotes',  icon: Inbox, badgeAccent: 'purple' },
          { id: 'amendments',  label: 'Amendments',      to: '/admin/amendments',  icon: PencilRuler, badgeAccent: 'orange' },
